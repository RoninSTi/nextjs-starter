    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-card rounded-lg shadow-sm p-6">
          ...
          <div className="mt-4">
            <p className="text-sm text-muted-foreground">
              These buttons will generate telemetry data by sending requests to the
              test endpoint. Approximately 20% of requests will generate errors to
        ...
        <div className="bg-card rounded-lg shadow-sm p-6">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Note: The iframe may not load Jaeger UI due to browser security settings.
            If it doesn&apos;t appear, please open Jaeger UI directly in a new tab.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="prose prose-sm max-w-none dark:prose-invert">
          <p>
            OpenTelemetry is set up to automatically trace all API endpoints and database operations.
            You can also add custom spans and attributes to your code:
          </p>
